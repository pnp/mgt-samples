...
If you have questions about how to use the Microsoft Graph Toolkit or any of the provided samples, please use the following locations.

* [Microsoft Graph](https://techcommunity.microsoft.com/t5/microsoft-graph/bd-p/OfficeGraph) at http://techcommunity.microsoft.com
* [Stack Overflow](https://stackoverflow.com/questions/tagged/microsoft-graph-toolkit) with 'microsoft-graph-toolkit' tag
...
* Folder should start by identifying JS library used - like `javascript`, `react-`, `angular-`, `knockout-`
* If you are not using any specific JS library, please use `js-` as the prefix for your sample
* Do not use words such as `sample`, `mgt` or `graph` in the folder or sample name - these are samples for Microsoft Graph Toolkit repository
* If your solution is demonstrating multiple technologies, please use functional terms as the name for the solution folder
* Do not use period/dot in the folder name of the provided sample

### Source Code

* For security reasons, we do not accept pull requests containing executable files, such as `.exe` or `.dll`. We only accept source code files for applications. 
